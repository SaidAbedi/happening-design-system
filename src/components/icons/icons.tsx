import { IconSvg, type IconSvgProps, type IconGradient, type IconGradientMode } from './Icon';
...
export const CalendarIcon = (props: IconComponentProps) => {
  const { fill, stroke } = getColors(props.gradient, props.gradientId, props.gradientMode);
  return (
    <IconSvg {...props}>
...
export const SearchIcon = (props: IconComponentProps) => {
  const { stroke } = getColors(props.gradient, props.gradientId, props.gradientMode);
  return (
    <IconSvg {...props}>
