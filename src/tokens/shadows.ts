...
export const shadowsLight = {
  ...
  inset: 'inset 6px 6px 12px rgba(180, 165, 155, 0.4), inset -6px -6px 12px rgba(255, 255, 255, 0.9)',
  ...
  glowSubtle: '0 0 16px rgba(196, 117, 106, 0.2), 6px 6px 12px rgba(180, 165, 155, 0.35), -6px -6px 12px rgba(255, 255, 255, 0.8)',

  // Teal glow effect - secondary actions, info states
  glowTeal: '0 0 24px rgba(90, 154, 154, 0.3), 8px 8px 16px rgba(180, 165, 155, 0.35), -8px -8px 16px rgba(255, 255, 255, 0.8)',

  // Pressed/active state
  pressed: 'inset 4px 4px 8px rgba(180, 165, 155, 0.5), inset -4px -4px 8px rgba(255, 255, 255, 0.6)',
  ...
  rimInset: 'inset 0 0 0 2px rgba(196, 117, 106, 0.15), inset 6px 6px 12px rgba(180, 165, 155, 0.4), inset -6px -6px 12px rgba(255, 255, 255, 0.9)',

  // Raised with teal rim - secondary buttons, teal highlights
  rimTeal: 'inset 0 0 0 2px rgba(90, 154, 154, 0.2), 8px 8px 16px rgba(180, 165, 155, 0.4), -8px -8px 16px rgba(255, 255, 255, 0.9)',
} as const;
...
export const shadowsDark = {
  ...
  // Deep inset
  inset: 'inset 6px 6px 12px rgba(10, 8, 6, 0.8), inset -6px -6px 12px rgba(50, 45, 40, 0.08)',
  ...
  glowSubtle: '0 0 16px rgba(212, 133, 106, 0.2), 6px 6px 12px rgba(10, 8, 6, 0.5), -6px -6px 12px rgba(50, 45, 40, 0.1)',

  // Teal glow effect
  glowTeal: '0 0 24px rgba(106, 172, 172, 0.35), 8px 8px 16px rgba(10, 8, 6, 0.6), -8px -8px 16px rgba(50, 45, 40, 0.1)',

  // Pressed/active state
  pressed: 'inset 4px 4px 8px rgba(10, 8, 6, 0.7), inset -4px -4px 8px rgba(50, 45, 40, 0.08)',
  ...
  rimInset: 'inset 0 0 0 2px rgba(212, 133, 106, 0.25), inset 6px 6px 12px rgba(10, 8, 6, 0.8), inset -6px -6px 12px rgba(50, 45, 40, 0.08)',

  // Raised with teal rim
  rimTeal: 'inset 0 0 0 2px rgba(106, 172, 172, 0.3), 8px 8px 16px rgba(10, 8, 6, 0.7), -8px -8px 16px rgba(50, 45, 40, 0.12)',
} as const;
